...
public class UserService {
    ...
    private static final String PASSWORD_POLICY_MESSAGE = "Mật khẩu phải chứa từ 8 ký tự bao gồm chữ hoa, chữ thường, số, ký tự đặc biệt và không có khoảng trống.";
