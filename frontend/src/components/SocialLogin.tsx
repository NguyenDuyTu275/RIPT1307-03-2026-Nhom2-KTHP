...
const SocialLogin: React.FC<SocialLoginProps> = () => {
  ...
  const googleLogin = useGoogleLogin({
    ...
    onError: () => {
      message.error('Không thể kết nối Google. Vui lòng thử lại!');
    },
  });
  ...
  const handleFacebook = () => {
    message.info({
      content: (
        <span>
          Tính năng Facebook Login cần cấu hình <strong>Facebook App ID</strong>.
          Xem hướng dẫn trong file <code>.env</code>.
        </span>
      ),
      duration: 4,
    });
  ...
  return (
    <div className="social-login">
      ...
      <div className="social-buttons">
        ...
        {/* FACEBOOK */}
        <button className="social-btn facebook-btn" onClick={handleFacebook}>
